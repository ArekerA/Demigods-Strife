...
class Umiejętność {
    ...
    private int koszt;
    public Umiejętność(String nazwa, String opis, String grafika, int obrazenia, int plusObrazenia, int plusObrazeniaProcent, int manaRegen, int hpRegen, int lifeSteal,  int szybkosc,  int unik,  int minusObrona,  int minusObronaProcentc,  int czasTrwania,  int koszt )
    {

    }
    public Umiejętność ZwróćUmiejętność(){
		return null;
